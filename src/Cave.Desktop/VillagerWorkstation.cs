...
internal sealed class VillagerWorkstation:Form
{
    ...
    internal VillagerWorkstation(Action<string,object?> send,Action returnToCave)
    {
        ...
        this.send=send;this.returnToCave=returnToCave;Text="Cozy Cave — Villager workstation";ClientSize=new Size(1000,680);MinimumSize=new Size(760,520);StartPosition=FormStartPosition.CenterScreen;BackColor=Color.FromArgb(65,51,36);KeyPreview=true;
